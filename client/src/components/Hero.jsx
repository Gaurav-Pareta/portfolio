...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className=" min-h-screen flex items-center justify-between px-6 md:px-12 lg:px-30 pt-20"
    >
      {/* Left Content */}
      <div className="max-w-xl">
        ...
        <a
          href="/Gaurav_Pareta_Resume.pdf"
          download="Gaurav_Pareta_Resume.pdf"
          className="bg-red-600 hover:bg-red-700 text-white
  font-semibold rounded-2xl px-8 py-3 mb-10
      ...
      bg-red-900/30 blur-3xl scale-110"
        ...
        <div className="mt-8 text-center">
          <p className="text-gray-400 text-sm font-mono">
            <span className="text-red-400 animate-pulse">█</span> Coding with
            passion
          </p>
        </div>
      </div>
